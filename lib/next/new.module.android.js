...
function detectIBeacons(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(PARSER_IBEACON, TYPE_IBEACON, resolve, reject);
  });
}
...
function removeIBeaconsDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(PARSER_IBEACON, TYPE_IBEACON, resolve, reject);
  });
}
// #enregion
...
function detectAltBeacons(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(PARSER_ALTBEACON, TYPE_ALTBEACON, resolve, reject);
  });
}
...
function removeAltBeaconsDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(PARSER_ALTBEACON, TYPE_ALTBEACON, resolve, reject);
  });
}
// #endregion
...
function detectEstimotes(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(PARSER_ESTIMOTE, TYPE_ESTIMOTE, resolve, reject);
  });
}
...
function removeEstimotesDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(PARSER_ESTIMOTE,TYPE_ESTIMOTE, resolve, reject);
  });
}
// #endregion
...
function detectEddystoneUID(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(PARSER_EDDYSTONE_UID,TYPE_EDDYSTONE_UID, resolve, reject);
  });
}
...
function removeEddystoneUIDDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(PARSER_EDDYSTONE_UID, TYPE_EDDYSTONE_UID, resolve, reject);
  });
}
// #endregion
...
function detectEddystoneURL(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(PARSER_EDDYSTONE_URL, TYPE_EDDYSTONE_URL, resolve, reject);
  });
}
...
function removeEddystoneURLDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(PARSER_EDDYSTONE_URL, TYPE_EDDYSTONE_URL, resolve, reject);
  });
}
// #endregion
...
function detectEddystoneTLM(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(PARSER_EDDYSTONE_TLM, TYPE_EDDYSTONE_TLM, resolve, reject);
  });
}
...
function removeEddystoneTLMDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(PARSER_EDDYSTONE_TLM, TYPE_EDDYSTONE_TLM, resolve, reject);
  });
}
// #endregion


// #region eddystone EID
/**
 * set beacon layout for eddystone EID
 *
 */
function detectEddystoneEID(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(PARSER_EDDYSTONE_EID,TYPE_EDDYSTONE_EID, resolve, reject);
  });
}

/**
 * same as detectEddystoneEID (intoduced in v1.1.0)
 * adds EddystoneEID parser to detect them
 *
 */
function addEddystoneEIDDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(PARSER_EDDYSTONE_EID, TYPE_EDDYSTONE_EID, resolve, reject);
  });
}
...
/**
 * removes EddystoneEID parser to stop detecting them
 *
 */
function removeEddystoneEIDDetection(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(PARSER_EDDYSTONE_EID, TYPE_EDDYSTONE_EID, resolve, reject);
  });
}
// #endregion
...
function detectCustomBeaconLayout(parser: number): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.addParser(parser, TYPE_CUSTOM_LAYOUT, resolve, reject);
  });
}
...
function removeCustomBeaconLayoutDetection(parser: number): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.removeParser(parser, TYPE_CUSTOM_LAYOUT, resolve, reject);
  });
}
// #endregion
...
module.exports = {
  ...
  detectEddystoneEID,
  addEddystoneEIDDetection,
  removeEddystoneEIDDetection,
