...
export const PARSER_EDDYSTONE_EID: string   = 
  's:0-1=feaa,m:2-2=30,p:3-3:-41,i:4-11';

export const TYPE_IBEACON: string = "iBeacon";
export const TYPE_ESTIMOTE:string = "Estimote";
export const TYPE_ALTBEACON:string = "Altbeacon";
export const TYPE_EDDYSTONE_TLM:string = "EddystoneTLM";
export const TYPE_EDDYSTONE_UID:string ="EddystoneUID";
export const TYPE_EDDYSTONE_URL:string = "EddystoneURL";
export const TYPE_EDDYSTONE_EID:string = "EddystoneEID";
export const TYPE_CUSTOM_LAYOUT:string = "CustomLayout";
...
export type BeaconsManagerANDROID = {
  ...
  detectEddystoneEID: () => Promise<any>,
  addEddystoneEIDDetection: () => Promise<any>,
  removeEddystoneEIDDetection: () => Promise<any>,
